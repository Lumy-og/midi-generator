...
def parse_arguments():
    ...
    parser.add_argument("-m", "--mood", metavar="", choices=mood_choices, default=mood,
                        help="Choose mood of the melody")
    parser.add_argument("-s", "--speed", metavar="", default=speed,
                        help="Choose speed of the melody", choices=speed_choices)
    parser.add_argument("-l", "--length", metavar="", type=int, choices=range(l1, l2), default=None,
    ...
    instrument.add_argument("-in", "--instrumentName", metavar="", default=instrument1,
